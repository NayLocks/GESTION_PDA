 ...
 */
final class Version20220825081046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pda (id INT IDENTITY NOT NULL, serial_number NVARCHAR(255), imei NVARCHAR(255), PRIMARY KEY (id))');
